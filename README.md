...
Debian 13, interactive terminal, `curl`, `sudo`, a sudo-capable development user, and **Deno on PATH** (or let the dev stack install the pinned **`2.9.0`** runtime under `/opt/turbopanel/vendor/deno/`).
